...
v <- c(
  4.3, 4.9, 4.9, 4.3, 4.9, 4.9, 5.8, 7.0, 7.9, 5.8, 7.0, 7.9,
  2.3, 2.0, 2.2, 2.3, 2.0, 2.2, 4.4, 3.4, 3.8, 4.4, 3.4, 3.8,
  1.0, 3.0, 4.5, 1.0, 3.0, 4.5, 1.9, 5.1, 6.9, 1.9, 5.1, 6.9,
  0.1, 1.0, 1.4, 0.1, 1.0, 1.4, 0.6, 1.8, 2.5, 0.6, 1.8, 2.5
)
