#ifndef __IO_EUCLID_JOIN_H
#define __IO_EUCLID_JOIN_H

#include "../../../helpers.h"

double io_euclid_join_distanceToClusters(Interval *elem, Interval **centers,
...
void io_euclid_join_update(Interval **elements, Interval **centers, bool **asso,
